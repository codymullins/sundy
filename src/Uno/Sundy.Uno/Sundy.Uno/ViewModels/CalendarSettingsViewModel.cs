...
public partial class CalendarItemViewModel(Calendar calendar, Func<CalendarItemViewModel, CancellationToken, Task>? onDeleteRequested = null) : ObservableObject
{
    ...
    private async Task Delete(CancellationToken ct)
    {
        ...
        {
            await onDeleteRequested(this, ct);
        }
    }
}
